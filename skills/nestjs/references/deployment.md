...
If Mau isn't installed yet, the command offers to add `@nestjs/mau` as a dev dependency and then continues. Any options you pass are forwarded straight to Mau. See [nest deploy](https://docs.nestjs.com/cli/usages#nest-deploy) for details.
...
<table>
  ...
  <tr>
    ...
    <td>Logs are collected and viewable in the dashboard. JSON logging is especially useful here - see the <a href="https://docs.nestjs.com/techniques/logger">Logger chapter</a>.</td>
  </tr>
  <tr>
