...
> info **Hint** Ideally, instead of using the `Record<string, any>` type, we should use a DTO class to define the shape of the request body. See the [validation](https://docs.nestjs.com/techniques/validation) chapter for more information.
