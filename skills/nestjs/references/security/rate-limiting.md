...
Once the module has been imported, choose how to bind the `ThrottlerGuard`. Any kind of binding described in the [guards](https://docs.nestjs.com/guards#binding-guards) chapter works. For example, to bind the guard globally, add this provider to any module:
...
<table>
  <tr>
    ...
    <td>a custom storage service that keeps track of the throttling. See <a href="https://docs.nestjs.com/security/rate-limiting#storages">Storages</a></td>
  </tr>
  <tr>
    <td><code>ignoreUserAgents</code></td>
    <td>an array of regular expressions matching user agents to ignore when throttling requests</td>
