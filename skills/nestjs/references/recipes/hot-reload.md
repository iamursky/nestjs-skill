...
If you use the [Nest CLI](https://docs.nestjs.com/cli/overview), the configuration process is straightforward. The CLI wraps `webpack`, which lets you use the `HotModuleReplacementPlugin`.
...
If you don't use the [Nest CLI](https://docs.nestjs.com/cli/overview), the configuration is slightly more complex and requires more manual steps.
