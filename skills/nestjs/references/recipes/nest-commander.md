...
Expanding on the [standalone applications](https://docs.nestjs.com/standalone-applications) chapter, the [nest-commander](https://nest-commander.jaymcdoniel.dev) package lets you write command-line applications with a structure similar to a typical Nest application.
