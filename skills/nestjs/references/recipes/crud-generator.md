...
To speed up this repetitive process, the [Nest CLI](https://docs.nestjs.com/cli/overview) provides a generator (schematic) that generates all of this boilerplate code automatically.
