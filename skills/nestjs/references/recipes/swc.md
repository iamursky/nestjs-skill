...
> info **Hint** If your repository is a monorepo, see the [Monorepo](https://docs.nestjs.com/recipes/swc#monorepo) section.
...
For all [circular dependency injections](https://docs.nestjs.com/fundamentals/circular-dependency) in your project, you also need to use the custom wrapper type described above:
...
If you use NestJS CLI plugins in your project, you have to run `PluginMetadataGenerator` manually. See the [Monorepo and CLI plugins](https://docs.nestjs.com/recipes/swc#monorepo-and-cli-plugins) section to learn more.
