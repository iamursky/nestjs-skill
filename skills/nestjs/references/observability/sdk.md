...
| ---------------- | -------- | -------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `appKey`         | `string` | -        | Generated from your project's **API Keys** page - see [First project](https://docs.nestjs.com/observability/overview#first-project). Keep it out of source control.                                                              |
...
Because the default generator adopts an incoming `x-request-id`, a chain of HTTP services already shares one trace with no extra configuration. Propagating across gRPC, `@nestjs/microservices` transports, and GraphQL takes a few lines - see [Distributed tracing](https://docs.nestjs.com/observability/distributed-tracing).
