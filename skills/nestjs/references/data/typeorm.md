> Source: https://github.com/nestjs/docs.nestjs.com/blob/master/content/data/typeorm.md
...
<table>
  ...
  <tr>
    ...
    <td>If <code>true</code>, entities are loaded automatically (default: <code>false</code>). See <a href="https://docs.nestjs.com/data/typeorm#auto-load-entities">Auto-load entities</a></td>
  </tr>
  <tr>
...
> error **Warning** Event subscribers cannot be [request-scoped](https://docs.nestjs.com/fundamentals/injection-scopes).
...
The factory behaves like any other [asynchronous provider](https://docs.nestjs.com/fundamentals/async-providers) (e.g., it can be `async`, and it can inject dependencies through `inject`).
