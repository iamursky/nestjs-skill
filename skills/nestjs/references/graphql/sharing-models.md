...
> info **Hint** The [TypeORM](https://docs.nestjs.com/data/typeorm) package provides a similar [model shim](https://github.com/typeorm/typeorm/blob/master/extra/typeorm-model-shim.js).
