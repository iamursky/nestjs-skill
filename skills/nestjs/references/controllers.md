...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td>request cookies / the cookie named <code>name</code> (see <a href="https://docs.nestjs.com/techniques/cookies">Cookies</a>)</td>
    </tr>
    <tr>
...
> info **Hint** To learn how to create your own decorators, see the [Custom route decorators](https://docs.nestjs.com/custom-decorators) chapter.
...
> info **Hint** Declare routes with parameters after any static paths, so that the parameterized path doesn't intercept traffic destined for the static one. See [Route conflicts and resolution order](https://docs.nestjs.com/controllers#route-conflicts-and-resolution-order) for the options that detect this at bootstrap or resolve it for you.
...
> info **Hint** The Nest CLI provides a generator (schematic) that automatically creates **all the boilerplate code**, so you don't have to write it manually. Learn more in the [CRUD generator](https://docs.nestjs.com/recipes/crud-generator) recipe.
