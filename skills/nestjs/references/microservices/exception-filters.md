...
The only difference between the HTTP [exception filter](https://docs.nestjs.com/exception-filters) layer and the corresponding microservices layer is that microservices should throw `RpcException` instead of `HttpException`.
