...
> info **Hint** To speed up development builds, use the [SWC builder](https://docs.nestjs.com/recipes/swc) by passing the `-b swc` flag to the `start` script: `npm run start -- -b swc`.
