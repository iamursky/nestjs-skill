> Source: https://github.com/nestjs/docs.nestjs.com/blob/master/content/http/sessions.md

# Session

**HTTP sessions** store information about the user across multiple requests, which is particularly useful for [MVC](https://docs.nestjs.com/http/mvc) applications.
