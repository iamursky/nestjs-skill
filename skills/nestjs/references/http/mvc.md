> Source: https://github.com/nestjs/docs.nestjs.com/blob/master/content/http/mvc.md
...
As mentioned in the [Performance (Fastify)](https://docs.nestjs.com/http/performance) chapter, you can use any compatible HTTP provider with Nest. One such library is [Fastify](https://github.com/fastify/fastify). To create an MVC application with Fastify, install the following packages:
