...
To get started, you can either scaffold the project with the [Nest CLI](https://docs.nestjs.com/cli/overview) or [clone a starter project](#alternatives). Both produce the same outcome.

To scaffold the project with the Nest CLI, run the following commands. They create a new project directory and populate it with the initial core Nest files and supporting modules, giving your project a conventional base structure. We recommend the **Nest CLI** for first-time users, and the [First steps](https://docs.nestjs.com/first-steps) chapter continues with this approach.
