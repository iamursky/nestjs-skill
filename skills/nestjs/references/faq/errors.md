...
> info **Hint** Check out the [NestJS Devtools](https://docs.nestjs.com/devtools/overview#investigating-the-cannot-resolve-dependency-error) which can help you resolve the "Cannot resolve dependency" error effortlessly.
