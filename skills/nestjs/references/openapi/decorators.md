...
The shorthand response decorators (e.g., `@ApiOkResponse()` and `@ApiNotFoundResponse()`, listed in the [operations](https://docs.nestjs.com/openapi/operations#responses) chapter) can be applied at the same levels as `@ApiResponse()`.
