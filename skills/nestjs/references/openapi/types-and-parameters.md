...
The definition is empty, even though the class declares a few properties. To make the class properties visible to the `SwaggerModule`, either annotate them with the `@ApiProperty()` decorator or use the [CLI plugin](https://docs.nestjs.com/openapi/cli-plugin), which does this automatically:
...
> info **Hint** Instead of manually annotating each property, consider using the [Swagger plugin](https://docs.nestjs.com/openapi/cli-plugin), which adds these annotations for you.
...
> info **Hint** Consider using the [Swagger plugin](https://docs.nestjs.com/openapi/cli-plugin), which detects arrays automatically.
...
> info **Hint** Consider using the [Swagger plugin](https://docs.nestjs.com/openapi/cli-plugin), which detects circular dependencies automatically.
