...
> info **Hint** Instead of manually annotating each property, consider using the Swagger plugin (see [Plugin](https://docs.nestjs.com/openapi/cli-plugin) section) which will automatically provide this for you.
...
> info **Hint** Consider using the Swagger plugin (see [Plugin](https://docs.nestjs.com/openapi/cli-plugin) section) which will automatically detect arrays.
...
> info **Hint** Consider using the Swagger plugin (see [Plugin](https://docs.nestjs.com/openapi/cli-plugin) section) which will automatically detect circular dependencies.
