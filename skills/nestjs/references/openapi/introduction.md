...
Nest route parameter decorators accept a [Standard Schema](https://standardschema.dev/) compatible schema through their `schema` option (see the [Controllers chapter](https://docs.nestjs.com/controllers#request-object)):
