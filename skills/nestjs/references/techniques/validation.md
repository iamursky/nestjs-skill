...
> info **Hint** The same schemas can drive your OpenAPI document. See [Standard Schema (Zod, Valibot)](https://docs.nestjs.com/openapi/introduction#standard-schema-zod-valibot) in the OpenAPI chapter.
