...
As mentioned in this [chapter](https://docs.nestjs.com/techniques/performance), we can use any compatible HTTP provider together with Nest. One such library is [Fastify](https://github.com/fastify/fastify). To create an MVC application with Fastify, install the following packages:
