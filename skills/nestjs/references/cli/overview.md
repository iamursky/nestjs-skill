...
> info **Hint** We recommend using the [SWC builder](https://docs.nestjs.com/recipes/swc) for faster builds (10x more performant than the default TypeScript compiler).
