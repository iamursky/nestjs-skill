...
> info **Hint** The schematic deliberately does not migrate your project to ESM, Vitest, or oxlint. Those are the defaults for newly generated v12 projects, but existing projects can adopt them on their own schedule. See the [Migration guide](https://docs.nestjs.com/migration-guide) for the full picture.
...
Because Mau owns the terminal once it starts, its output and any prompts it shows are passed through to you directly. See the [Deployment chapter](https://docs.nestjs.com/deployment#easy-deployment-with-mau) for what Mau does and how to configure it.
