...
The WebSockets exceptions layer works like the HTTP [exception filter](https://docs.nestjs.com/exception-filters) layer, with one difference: instead of throwing `HttpException`, throw `WsException`.
