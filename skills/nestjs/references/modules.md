...
```typescript title="feature-flags.module.ts"
...
```typescript title="core.module.ts"
import { Module } from '@nestjs/common';
import { FeatureFlagsModule } from '../feature-flags/feature-flags.module.js';
...
> info **Hint** To learn how to build highly customizable dynamic modules with `ConfigurableModuleBuilder`, see the [Configurable module builder](https://docs.nestjs.com/fundamentals/dynamic-modules#configurable-module-builder) section.
